...
func NewHttpServer(httpServer *http.Server, debug bool) *Server {
...
// new server
func NewServer(addr string, handler http.Handler, readTimeout, writeTimeout time.Duration, debug bool) *Server {
